...
export class SummernoteComponent implements OnInit {
  ...
  private async _loadSummernote() {
    ...
    if (!this.loadedComponents && !(window as any).jQuery) {
      // await this.loadExternalFilesService.loadFile('http://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.js')
      ...
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/jquery.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-lite.css')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-lite.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-ext-print.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-ext-nugget.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-ext-template.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-list-styles.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-list-styles.css')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-pagebreak.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-paper-size.js')
      await this.loadExternalFilesService.loadFile(location.origin + location.pathname + 'assets/summernote/summernote-table-headers.js')
